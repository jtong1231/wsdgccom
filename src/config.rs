...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("向议通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.fni32fklds.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 42906;
pub const RELAY_PORT: i32 = 42907;
pub const WS_RENDEZVOUS_PORT: i32 =42908;
pub const WS_RELAY_PORT: i32 = 42909;
