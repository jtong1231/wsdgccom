...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("会定云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.67.17"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 39456;
pub const RELAY_PORT: i32 = 39457;
pub const WS_RENDEZVOUS_PORT: i32 =39458;
pub const WS_RELAY_PORT: i32 = 39459;
