...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.13.108"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 35156;
pub const RELAY_PORT: i32 = 35157;
pub const WS_RENDEZVOUS_PORT: i32 =35158;
pub const WS_RELAY_PORT: i32 = 35159;
