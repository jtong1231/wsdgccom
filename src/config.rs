...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.84.24"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 32756;
pub const RELAY_PORT: i32 = 32757;
pub const WS_RENDEZVOUS_PORT: i32 =32758;
pub const WS_RELAY_PORT: i32 = 32759;
